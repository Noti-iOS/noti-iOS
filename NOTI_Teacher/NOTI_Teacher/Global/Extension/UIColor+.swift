...
extension UIColor {
    ...
    @nonobjc class var main20: UIColor {
        return UIColor(red: 11.0/255.0, green: 159.0/255.0, blue: 119.0/255.0, alpha: 0.2)
    }
    ...
    @nonobjc class var sub2: UIColor {
        return UIColor(red: 231.0/255.0, green: 245.0/255.0, blue: 241.0/255.0, alpha: 1.0)
    }
    ...
    @nonobjc class var line_gray: UIColor {
